...
Інструкція запуску в кінці цього документу!
...
<br>-p - номер порту, який використовуватиме сервер.
<br>-d - час протягом якого сервер надаватиме відповідь.

## Додавання зображень на сервер
Для того, щоб додати потрібні нам зображення, варто в папці, де знаходиться файл db.json створити ще одну директорію з назвою public. В папці public стоврюєте ще одну з назвою images. Саме в папці images розміщуєте потрібні вам зображення. Щасти :)

Посилання папку із зображеннями
https://drive.google.com/drive/folders/14YKodcgSQEzDSLdxuZRqgs4I5gsyFheH?usp=sharing
